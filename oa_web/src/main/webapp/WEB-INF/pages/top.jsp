                ...
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        <a class="media-left" href="#" >
                           <img src="assets/img/avatars/3.jpg" class="img-responsive"></a>
                        </a>
            ...
            <ul class="nav sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="nav sub-nav">
                        <li>
                            <a href="/employee/selectEmpByPage?currentPage=1">
                ...
                <li>
                    ...
                    <ul class="nav sub-nav">
                        <li>
                            <a href="/department/selectByPage?currentPage=1">
