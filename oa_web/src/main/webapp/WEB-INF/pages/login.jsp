        ...
        window.onload = function(){
          ...
          /*  var login = document.getElementById("submit");
            login.onclick = function(){
                var selected = $("input:checkbox").is(':checked');
                if(selected){
                    $("#remember").val("1");
                }
            }*/

          var ch = ${cookie.sn.value};
                ...
                <div class="panel mt30 mb25">
                    <form method="post" action="login" id="contact">
                        <div class="panel-body bg-light p25 pb15">
                            <div class="section">
                                ...
                                <label for="sn" class="field prepend-icon">
                                    <input type="text" name="sn" id="sn" class="gui-input" value="${cookie.sn.value}" placeholder="请输入工号...">
                            ...
                            <div class="section">
                                ...
                                <label for="password" class="field prepend-icon">
                                    <input type="password" name="password" id="password" value="${cookie.password.value}" class="gui-input" placeholder="请输入密码...">
                        ...
                        <div class="panel-footer clearfix">
                            ...
                            <input type="submit"  id="submit" class="button btn-primary mr10 pull-right" value="登录">
